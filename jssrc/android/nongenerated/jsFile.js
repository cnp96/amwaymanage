...
function applyFilters() {
    var data = [];
    try {
        if (frmHome.checkBox.selectedKeyValues) frmHome.checkBox.selectedKeyValues.forEach((i => data.push(i[1])));
    } catch (e) {}
...
function onClickApply() {
    try {
        ...
        var sel = [];
        if (frmHome.checkBox.selectedKeyValues) frmHome.checkBox.selectedKeyValues.forEach((i => sel.push(i[1])));
